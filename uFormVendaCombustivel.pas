...
uses
    ...
    uFormBase, Vcl.StdCtrls, Vcl.ExtCtrls, FireDAC.Stan.Intf,
    FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
    FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt,
    Data.DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, Vcl.ComCtrls,
    Classe.Frentista, ACBrUtil, cxGraphics, cxControls, cxLookAndFeels,
...
function TfrmVendaCombustivel.CalcularComissao(BaseCalculo, PercComissao: double): double;
begin
