...
uses
    uFormLogin, uFormCadUsuarios, uFormSimpleCrud, uFormCadFrentistas,
    uFormCadBicosCombustivel, uFormCadBombas, uFormCadCombustivel,
    uFormCadTanquesCombustivel, uFormBase, uFormVendaCombustivel,
    uFormCadEntradas, uFormEntradas, uFormRelLucroPeriodo, uFormRelTotalGeral,
    uFormRelComissao;
